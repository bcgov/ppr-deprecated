...
These buildconfigs can be used to create a fresh imagestream, which can be used in a Jenkinsfile.
...
```
oc process -f openshift/<..>.bc.yaml | oc [create|replace] -n <PROJECT> -f -
```
